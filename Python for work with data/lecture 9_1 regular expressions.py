...
# Из стро нужно выделить только восклицательные отзывы / предложения
tweet_2 = "Какое замечательное место! Обязательно вернусь сюда снова. Всем советую!!!"
# Применяется метод split из модуля re. Её отличие от split в базовом наборе Python в том, что она
