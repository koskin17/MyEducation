...
class DlgMain(QMainWindow):
    ...
    def evt_btn_clicked(self):
        ...
        # if ok:
        #     QMessageBox.critical(self, "Name", "Your name is " + name)
        # else:
        ...
        res1, res2 = QInputDialog.getItem(self, "Color", "Enter Your favorite color: ", colors, editable=False)
        print(res1)
        if res2:
            QMessageBox.information(self, "About Your color", "Your favorite color is: " + res1)
        else:
            QMessageBox.critical(self, "Canceled", "User has clicked \"Cancel\"")
