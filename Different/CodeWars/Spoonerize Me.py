...
In its most basic form a spoonerism is a two word phrase in which only the first letters of each word
are swapped:
...
#     w1 = words.split(" ")[1][0] + words.split(" ")[0][1:]
#     w2= words.split(" ")[0][0] + words.split(" ")[1][1:]
#     return f"{w1} {w2}"
