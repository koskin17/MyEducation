...
def find_missing_letter(chars):
    ...
    letter = chars_alphabet.difference(chars_mn)                # методом difference, которое возвращает отсутствующие элементы во втором множестве, сравниваются 2 множества
    letter = ''.join(letter)                                    # буква возвращается в виде множества. Из неё формируется буква в виде строки
    return letter
